...
extension GeneralUtilsObjectExtension on Object {
  ...
  bool get isOrEmpty => _isStringObjectEmpty || _isIterableObjectEmpty;
  ...
  /// - empty `Iterable` (list, map, set, ...)
  /// - false `bool`
  bool get isEmptyOrFalse => _isStringObjectEmpty || _isIterableObjectEmpty || _isBoolObjectFalse;
  ...
  /// - false `bool`
  /// - zero `num`
  bool get iEmptyFalseOrZero =>
      _isStringObjectEmpty || _isIterableObjectEmpty || _isBoolObjectFalse || _isNumObjectZero;
